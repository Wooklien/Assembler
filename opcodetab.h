...
class opcodetab {
    ...
    private:
    	string codes={"ADD", "ADDF", "ADDR", "AND", "CLEAR", "COMP", "COMPF", "COMPR",
    			...
    			"TIXR", "WD"};
    	string mcode={"18","58","90","40","B4","28","88","A0","24","64","9C","C4","C0",
    	...
    	int size[]={3,3,2,3,2,3,3,2,3,3,2,1,1,1,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,2,1,3,3,2,
    			3,2,2,1,3,3,3,3,3,3,3,3,3,3,3,3,3,2,2,3,1,3,2,3};
